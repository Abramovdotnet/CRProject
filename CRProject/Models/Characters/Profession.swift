...
enum Profession: String, CaseIterable, Codable {
    ...
    case cityGuard      = "Patrol"
    case gardener        = "Gardener"
    case maintenanceWorker = "Maintenance"
    case cleaner         = "Cleaner"
    case apprentice      = "Apprentice"
    case lordLady       = "Noble"
    case administrator   = "Administrator"
    case stableHand     = "Horsman"
    case kitchenStaff   = "Staff"
    case militaryOfficer = "Officer"
    case servant        = "Servant"
    case monk           = "Monk"
    case religiousScholar = "Scholar"
    case generalLaborer = "Laborer"
