...
// MARK: - NPC Generator
func generateNPCs() -> [[String: Any]] {
    var npcs: [[String: Any]] = []
    var currentId = 1
    
    // Define professions
    let professions = [
        "blacksmith", "miller", "cooper", "chandler", "priest", "bowyer", "armorer",
        "merchant", "carpenter", "thatcher", "tanner", "weaver", "hunter", "tailor",
        "baker", "butcher", "brewer", "apothecary", "scribe", "herald", "minstrel",
        "guardman", "alchemist", "farrier", "innkeeper", "adventurer", "wenche", "general"
    ]
